function CampaignsActions (facade) {
  ...
  self.create = function () {
    return new Promise(function (resolve, reject) {
      ...
      facade.call('POST', facade.baseapi + '/v1/campaigns', data).then(function (campaign) {
  ...
  self.createItemDropdown = function () {
    return new Promise(function (resolve, reject) {
      ...
      facade.call('POST', facade.baseapi + '/v1/campaigns/items/dropdown', payload).then(function (item) {
        self.facade.setLoading(false)
  ...
  self.createItemYesNo = function () {
    return new Promise(function (resolve, reject) {
      ...
      facade.call('POST', facade.baseapi + '/v1/campaigns/items/yes-no', payload).then(function (item) {
        self.facade.setLoading(false)
  ...
  self.update = function (campaign) {
    return new Promise(function (resolve, reject) {
      ...
      delete data.company
      self.facade.setLoading(true)
      facade.call('PATCH', facade.baseapi + '/v1/campaigns/' + campaign.urn, data).then(function (campaign) {
        self.facade.setLoading(false)
  ...
  self.updateItem = function (item) {
    return new Promise(function (resolve, reject) {
      ...
      self.facade.setLoading(true)
      facade.call('PATCH', facade.baseapi + '/v1/campaigns/items/' + item.urn, data).then(function (item) {
        self.facade.setLoading(false)
  ...
  self.updateItemChoice = function (choice) {
    return new Promise(function (resolve, reject) {
      ...
      delete data.urnItem
      self.facade.setLoading(true)
      facade.call('PATCH', facade.baseapi + '/v1/choices/' + choice.urn, data).then(function (choice) {
        self.facade.setLoading(false)
  ...
  self.selectCampaign = function (urn) {
    return new Promise(function (resolve, reject) {
      self.facade.setLoading(true)
      self.facade.call('GET', facade.baseapi + '/v1/campaigns/' + urn)
  ...
  self.selectCampaignItem = function (urn) {
    return new Promise(function (resolve, reject) {
      self.facade.setLoading(true)
      self.facade.call('GET', facade.baseapi + '/v1/campaigns/items/' + urn)
        .then(function (item) {
  ...
  self.createCampaignItemChoice = function () {
    return new Promise(function (resolve, reject) {
      ...
      self.facade.setLoading(true)
      self.facade.call('POST', facade.baseapi + '/v1/choices', data)
        .then(function (item) {
  ...
  self.selectCampaignItemChoice = function (urn) {
    return new Promise(function (resolve, reject) {
      self.facade.setLoading(true)
      self.facade.call('GET', facade.baseapi + '/v1/choices/' + urn)
        .then(function (item) {
